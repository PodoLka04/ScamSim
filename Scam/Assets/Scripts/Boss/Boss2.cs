...
public class Boss2 : MonoBehaviour
{
    ...
    public GameObject boss2suget1Pan;
    public GameObject boss2suget2Pan;
    public GameObject boss2FinalWinPan;
    public GameObject boss2FinalLosePan;
    void Start()
    {
        boss2suget1Pan.SetActive(true);
        boss2suget2Pan.SetActive(false);
        boss2FinalWinPan.SetActive(false);
        boss2FinalLosePan.SetActive(false);
    ...
    void EndFight(bool playerWon)
    {
        ...
        if (playerWon)
        {
            ...
            boss2FinalWinPan.SetActive(true);
        ...
        else
        {
            ...
            boss2FinalLosePan.SetActive(true);
        }
    ...
    {
        boss2suget1Pan.SetActive(false);
        boss2suget2Pan.SetActive(true);
    }
