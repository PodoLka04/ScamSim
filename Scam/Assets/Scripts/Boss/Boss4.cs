...
{
    public GameObject boss4suget1Pan;
    public GameObject boss4suget2Pan;
    public GameObject boss4FinalWinPan;
    public GameObject boss4FinalLosePan;

    public GameObject kuzia;
    
    public int playerHealth = 100;         // Здоровье игрока
    public int bossHealth = 800;           // Здоровье босса
    ...
    void Start()
    {
        boss4suget1Pan.SetActive(true);
        boss4suget2Pan.SetActive(false);
        boss4FinalWinPan.SetActive(false);
        boss4FinalLosePan.SetActive(false);
    ...
    void EndFight(bool playerWon)
    {
        ...
        if (playerWon)
        {
            ...
            Data.Instance.Setboss4Win(true);  //типо победили!!!!!!
            
            boss4FinalWinPan.SetActive(true);
        ...
        else
        {
            ...
            boss4FinalLosePan.SetActive(true);
    ...
    {
        boss4suget1Pan.SetActive(false);
        boss4suget2Pan.SetActive(true);
    }
