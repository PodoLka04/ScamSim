...
public class Boss1 : MonoBehaviour
{
    ...
    public int bossHealth = 200;           // Здоровье босса
    ...
    public GameObject boss1suget1Pan;
    public GameObject boss1suget2Pan;
    public GameObject boss1TutorPan;
    public GameObject boss1FinalWinPan;
    public GameObject boss1FinalLosePan;

    void Start()
    {
        boss1suget1Pan.SetActive(true);
        boss1suget2Pan.SetActive(false);
        boss1TutorPan.SetActive(false);
        boss1FinalWinPan.SetActive(false);
        boss1FinalLosePan.SetActive(false);
    ...
    void EndFight(bool playerWon)
    {
        ...
        if (playerWon)
        {
            ...
            Data.Instance.Setboss1Win(true);
            
            boss1FinalWinPan.SetActive(true);
        ...
        else
        {
            ...
            boss1FinalLosePan.SetActive(true);
        }
    ...
    {
        boss1suget1Pan.SetActive(false);
        boss1suget2Pan.SetActive(true);
    }
    public void ToTutorpanel()
    {
        boss1suget2Pan.SetActive(false);
        boss1TutorPan.SetActive(true);
    }
    public void ToBoss()
    {
        boss1TutorPan.SetActive(false);
