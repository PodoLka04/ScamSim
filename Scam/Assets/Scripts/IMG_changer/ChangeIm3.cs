...
public class ChangeIm3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        previousBoss1Key = Data.Instance.Getboss3Win();
    ...
    void Update()
    {
        ...
        if (Data.Instance.Getboss3Win() != previousBoss1Key)
        {
