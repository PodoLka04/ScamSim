...
public class ChangeIm4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        previousBoss1Key = Data.Instance.Getboss4Win();
    ...
    void Update()
    {
        ...
        if (Data.Instance.Getboss4Win() != previousBoss1Key)
        {
